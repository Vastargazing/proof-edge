...
<!-- generated:headline -->
**2480 forecasts · 1092 on-chain anchors · 2458 public proofs · 0 undisclosed
production roots · Brier skill −0.267 across 7 model versions at N=2464.** The
...
`0.3006`; the market's is `0.2373`. Skill is `−0.2666`, with a deterministic
1,000-resample 95% interval from `−0.3072` to `−0.2270` at `N=2464`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0329` at `N=496`, with an interval from
`−0.0577` to `−0.0081`
...
windows, skill is `−0.2607` at `N=2247`, with a 95% interval from `−0.2979` to
`−0.2225`. Its risk-gate subset is `−0.0339` at `N=444`, with an interval from
`−0.0588` to `−0.0081`
...
At watermark block `476442338`, the audit sees 1093 on-chain
roots, 1092 disclosed roots and zero hidden roots
