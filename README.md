...
<!-- generated:headline -->
**4211 forecasts · 1817 disclosed roots · 4197 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4203.** The
...
1,000-resample 95% interval from `−0.2957` to `−0.2397` at `N=4203`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0217` at `N=776`, with an interval from
`−0.0409` to `−0.0022`
...
windows, skill is `−0.2652` at `N=3986`, with a 95% interval from `−0.2949` to
`−0.2356`. Its risk-gate subset is `−0.0216` at `N=724`, with an interval from
`−0.0417` to `−0.0007`
...
At watermark block `480364877`, the audit sees 1818 on-chain
anchor events. The ledger accounts for 1817 unique roots; zero
