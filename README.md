...
<!-- generated:headline -->
**2685 forecasts · 1180 on-chain anchors · 2663 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=2669.** The
...
`0.3008`; the market's is `0.2372`. Skill is `−0.2682`, with a deterministic
1,000-resample 95% interval from `−0.3069` to `−0.2338` at `N=2669`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0322` at `N=532`, with an interval from
`−0.0557` to `−0.0085`
...
windows, skill is `−0.2629` at `N=2452`, with a 95% interval from `−0.2984` to
`−0.2269`. Its risk-gate subset is `−0.0331` at `N=480`, with an interval from
`−0.0570` to `−0.0081`
...
At watermark block `476658160`, the audit sees 1181 on-chain
roots, 1180 disclosed roots and zero hidden roots
