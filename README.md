...
<!-- generated:headline -->
**3364 forecasts · 1461 disclosed roots · 3342 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=3348.** The
...
`0.3008`; the market's is `0.2370`. Skill is `−0.2690`, with a deterministic
1,000-resample 95% interval from `−0.3022` to `−0.2357` at `N=3348`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0276` at `N=639`, with an interval from
`−0.0485` to `−0.0062`
...
windows, skill is `−0.2648` at `N=3131`, with a 95% interval from `−0.2980` to
`−0.2310`. Its risk-gate subset is `−0.0279` at `N=587`, with an interval from
`−0.0487` to `−0.0072`
...
At watermark block `477989940`, the audit sees 1462 on-chain
anchor events. The ledger accounts for 1461 unique roots; zero
