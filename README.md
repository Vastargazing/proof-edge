...
<!-- generated:headline -->
**4473 forecasts · 1939 disclosed roots · 4449 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=4455.** The
...
18 newer forecasts were still waiting for resolution in the published snapshot.
...
`0.2968`; the market's is `0.2349`. Skill is `−0.2639`, with a deterministic
1,000-resample 95% interval from `−0.2917` to `−0.2383` at `N=4455`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0199` at `N=830`, with an interval from
`−0.0390` to `−0.0007`
...
windows, skill is `−0.2605` at `N=4238`, with a 95% interval from `−0.2893` to
`−0.2312`. Its risk-gate subset is `−0.0197` at `N=778`, with an interval from
`−0.0387` to `0.0008`
...
At watermark block `482524383`, the audit sees 1940 on-chain
anchor events. The ledger accounts for 1939 unique roots; zero
