...
<!-- generated:hook -->
Our estimator's Brier loss was 24.9% worse than the market's. We know
...
<!-- generated:headline -->
**1466 forecasts · 638 on-chain anchors · 1444 public proofs · 0 undisclosed
production roots · Brier skill −0.249 across 7 model versions at N=1450.** The
...
`0.2987`; the market's is `0.2392`. Skill is `−0.2489`, with a deterministic
1,000-resample 95% interval from `−0.2964` to `−0.2007` at `N=1450`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0393` at `N=311`, with an interval from
`−0.0670` to `−0.0086`
...
windows, skill is `−0.2351` at `N=1233`, with a 95% interval from `−0.2866` to
`−0.1844`. Its risk-gate subset is `−0.0423` at `N=259`, with an interval from
`−0.0736` to `−0.0077`
...
At watermark block `475362571`, the audit sees 639 on-chain
roots, 638 disclosed roots and zero hidden roots
