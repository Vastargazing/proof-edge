...
<!-- generated:headline -->
**386 forecasts · 174 on-chain anchors · 368 public proofs · 0 undisclosed
production roots · Brier skill −0.256 across 7 model versions at N=374.** The
...
`0.3050`; the market's is `0.2428`. Skill is `−0.2561`, with a deterministic
1,000-resample 95% interval from `−0.3623` to `−0.1564` at `N=374`
...
windows, skill is `−0.1637` at `N=157`, with a 95% interval from `−0.3266` to
`−0.0008`. Its risk-gate subset is `−0.0121` at `N=23`, with an interval from
`−0.1305` to `0.1154`
...
At watermark block `473778880`, the audit sees 174 on-chain
roots, 174 disclosed roots and zero hidden roots
