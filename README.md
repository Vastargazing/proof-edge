...
<!-- generated:headline -->
**4267 forecasts · 1845 disclosed roots · 4251 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4257.** The
...
`0.2991`; the market's is `0.2362`. Skill is `−0.2665`, with a deterministic
1,000-resample 95% interval from `−0.2969` to `−0.2374` at `N=4257`
...
windows, skill is `−0.2631` at `N=4040`, with a 95% interval from `−0.2936` to
...
At watermark block `481121304`, the audit sees 1846 on-chain
anchor events. The ledger accounts for 1845 unique roots; zero
