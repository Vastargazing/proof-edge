...
<!-- generated:headline -->
**4646 forecasts · 2016 disclosed roots · 4630 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=4636.** The
...
`0.2931`; the market's is `0.2337`. Skill is `−0.2543`, with a deterministic
1,000-resample 95% interval from `−0.2830` to `−0.2287` at `N=4636`
...
windows, skill is `−0.2507` at `N=4419`, with a 95% interval from `−0.2811` to
`−0.2204`. Its risk-gate subset is `−0.0167` at `N=810`, with an interval from
`−0.0363` to `0.0029`
...
At watermark block `482776326`, the audit sees 2017 on-chain
anchor events. The ledger accounts for 2016 unique roots; zero
