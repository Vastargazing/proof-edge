...
<!-- generated:headline -->
**408 forecasts · 184 on-chain anchors · 390 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=396.** The
...
`0.3065`; the market's is `0.2424`. Skill is `−0.2648`, with a deterministic
1,000-resample 95% interval from `−0.3651` to `−0.1663` at `N=396`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0209` at `N=80`, with an interval from
`−0.0835` to `0.0387`
...
windows, skill is `−0.1925` at `N=179`, with a 95% interval from `−0.3396` to
`−0.0513`. Its risk-gate subset is `−0.0171` at `N=28`, with an interval from
`−0.1156` to `0.0855`
...
At watermark block `474066770`, the audit sees 184 on-chain
roots, 184 disclosed roots and zero hidden roots
