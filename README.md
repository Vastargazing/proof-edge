...
<!-- generated:headline -->
**3709 forecasts · 1607 disclosed roots · 3687 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=3693.** The
...
`0.3004`; the market's is `0.2368`. Skill is `−0.2690`, with a deterministic
1,000-resample 95% interval from `−0.3009` to `−0.2355` at `N=3693`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0199` at `N=703`, with an interval from
`−0.0409` to `0.0016`
...
windows, skill is `−0.2653` at `N=3476`, with a 95% interval from `−0.2974` to
`−0.2313`. Its risk-gate subset is `−0.0197` at `N=651`, with an interval from
`−0.0416` to `0.0038`
...
At watermark block `478349962`, the audit sees 1608 on-chain
anchor events. The ledger accounts for 1607 unique roots; zero
