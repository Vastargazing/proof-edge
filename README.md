...
<!-- generated:headline -->
**1881 forecasts · 824 on-chain anchors · 1859 public proofs · 0 undisclosed
production roots · Brier skill −0.248 across 7 model versions at N=1865.** The
...
`0.2958`; the market's is `0.2370`. Skill is `−0.2480`, with a deterministic
1,000-resample 95% interval from `−0.2914` to `−0.2029` at `N=1865`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0229` at `N=383`, with an interval from
`−0.0503` to `0.0051`
...
windows, skill is `−0.2374` at `N=1648`, with a 95% interval from `−0.2821` to
`−0.1910`. Its risk-gate subset is `−0.0229` at `N=331`, with an interval from
`−0.0510` to `0.0057`
...
At watermark block `475794374`, the audit sees 825 on-chain
roots, 824 disclosed roots and zero hidden roots
