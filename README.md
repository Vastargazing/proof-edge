...
<!-- generated:headline -->
**2251 forecasts · 988 on-chain anchors · 2229 public proofs · 0 undisclosed
production roots · Brier skill −0.255 across 7 model versions at N=2235.** The
...
`0.2999`; the market's is `0.2389`. Skill is `−0.2554`, with a deterministic
1,000-resample 95% interval from `−0.2919` to `−0.2152` at `N=2235`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0333` at `N=451`, with an interval from
`−0.0591` to `−0.0063`
...
windows, skill is `−0.2476` at `N=2018`, with a 95% interval from `−0.2853` to
`−0.2064`. Its risk-gate subset is `−0.0345` at `N=399`, with an interval from
`−0.0609` to `−0.0090`
...
At watermark block `476190295`, the audit sees 989 on-chain
roots, 988 disclosed roots and zero hidden roots
