...
<!-- generated:headline -->
**4241 forecasts · 1832 disclosed roots · 4223 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4229.** The
...
`0.2994`; the market's is `0.2362`. Skill is `−0.2679`, with a deterministic
1,000-resample 95% interval from `−0.2976` to `−0.2396` at `N=4229`
...
windows, skill is `−0.2646` at `N=4012`, with a 95% interval from `−0.2985` to
`−0.2359`. Its risk-gate subset is `−0.0205` at `N=730`, with an interval from
`−0.0410` to `−0.0009`
...
At watermark block `480761320`, the audit sees 1833 on-chain
