...
<!-- generated:headline -->
**4215 forecasts · 1818 disclosed roots · 4199 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4205.** The
...
1,000-resample 95% interval from `−0.3006` to `−0.2393` at `N=4205`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0214` at `N=777`, with an interval from
`−0.0408` to `−0.0014`
...
windows, skill is `−0.2649` at `N=3988`, with a 95% interval from `−0.2937` to
`−0.2340`. Its risk-gate subset is `−0.0213` at `N=725`, with an interval from
`−0.0416` to `−0.0013`
...
At watermark block `480400861`, the audit sees 1819 on-chain
anchor events. The ledger accounts for 1818 unique roots; zero
