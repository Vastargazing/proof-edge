...
<!-- generated:headline -->
**1362 forecasts · 590 on-chain anchors · 1340 public proofs · 0 undisclosed
production roots · Brier skill −0.225 across 7 model versions at N=1346.** The
...
`0.2921`; the market's is `0.2385`. Skill is `−0.2249`, with a deterministic
1,000-resample 95% interval from `−0.2731` to `−0.1728` at `N=1346`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0389` at `N=307`, with an interval from
`−0.0660` to `−0.0092`
...
windows, skill is `−0.2053` at `N=1129`, with a 95% interval from `−0.2621` to
`−0.1537`. Its risk-gate subset is `−0.0419` at `N=255`, with an interval from
`−0.0751` to `−0.0090`
...
At watermark block `475254591`, the audit sees 591 on-chain
roots, 590 disclosed roots and zero hidden roots
