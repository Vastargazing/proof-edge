...
<!-- generated:hook -->
Our estimator's Brier loss was 25.1% worse than the market's. We know
...
<!-- generated:headline -->
**2113 forecasts · 924 on-chain anchors · 2091 public proofs · 0 undisclosed
production roots · Brier skill −0.251 across 7 model versions at N=2097.** The
...
`0.2975`; the market's is `0.2378`. Skill is `−0.2513`, with a deterministic
1,000-resample 95% interval from `−0.2895` to `−0.2110` at `N=2097`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0301` at `N=417`, with an interval from
`−0.0585` to `−0.0042`
...
windows, skill is `−0.2424` at `N=1880`, with a 95% interval from `−0.2842` to
`−0.2016`. Its risk-gate subset is `−0.0311` at `N=365`, with an interval from
`−0.0590` to `−0.0046`
...
At watermark block `476046146`, the audit sees 924 on-chain
roots, 923 disclosed roots and zero hidden roots
