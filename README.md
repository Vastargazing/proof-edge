...
<!-- generated:headline -->
**1087 forecasts · 479 on-chain anchors · 1065 public proofs · 0 undisclosed
production roots · Brier skill −0.213 across 7 model versions at N=1071.** The
...
`0.2876`; the market's is `0.2370`. Skill is `−0.2133`, with a deterministic
1,000-resample 95% interval from `−0.2717` to `−0.1583` at `N=1071`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0462` at `N=242`, with an interval from
`−0.0804` to `−0.0115`
...
windows, skill is `−0.1844` at `N=854`, with a 95% interval from `−0.2479` to
`−0.1182`. Its risk-gate subset is `−0.0522` at `N=190`, with an interval from
`−0.0899` to `−0.0132`
...
At watermark block `474966667`, the audit sees 480 on-chain
roots, 479 disclosed roots and zero hidden roots
