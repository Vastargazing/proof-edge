...
<!-- generated:hook -->
Our estimator's Brier loss was 26.6% worse than the market's. We know
...
<!-- generated:headline -->
**2344 forecasts · 1030 on-chain anchors · 2322 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=2328.** The
...
`0.3011`; the market's is `0.2379`. Skill is `−0.2656`, with a deterministic
1,000-resample 95% interval from `−0.3033` to `−0.2260` at `N=2328`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0318` at `N=472`, with an interval from
`−0.0581` to `−0.0074`
...
windows, skill is `−0.2592` at `N=2111`, with a 95% interval from `−0.3012` to
`−0.2163`. Its risk-gate subset is `−0.0328` at `N=420`, with an interval from
`−0.0594` to `−0.0066`
...
At watermark block `476298304`, the audit sees 1031 on-chain
roots, 1030 disclosed roots and zero hidden roots
