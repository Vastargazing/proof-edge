...
<!-- generated:headline -->
**3743 forecasts · 1621 disclosed roots · 3721 public proofs · 0 undisclosed
production roots · Brier skill −0.267 across 7 model versions at N=3727.** The
...
`0.2997`; the market's is `0.2366`. Skill is `−0.2669`, with a deterministic
1,000-resample 95% interval from `−0.2988` to `−0.2365` at `N=3727`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0200` at `N=705`, with an interval from
`−0.0415` to `0.0007`
...
windows, skill is `−0.2631` at `N=3510`, with a 95% interval from `−0.2947` to
`−0.2299`. Its risk-gate subset is `−0.0197` at `N=653`, with an interval from
`−0.0407` to `0.0013`
...
At watermark block `478385699`, the audit sees 1622 on-chain
anchor events. The ledger accounts for 1621 unique roots; zero
