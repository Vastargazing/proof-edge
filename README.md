...
<!-- generated:headline -->
**4211 forecasts · 1816 disclosed roots · 4193 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4199.** The
...
`0.2998`; the market's is `0.2363`. Skill is `−0.2687`, with a deterministic
1,000-resample 95% interval from `−0.2993` to `−0.2376` at `N=4199`
...
windows, skill is `−0.2654` at `N=3982`, with a 95% interval from `−0.2973` to
`−0.2370`. Its risk-gate subset is `−0.0219` at `N=722`, with an interval from
`−0.0403` to `−0.0019`
...
At watermark block `480329119`, the audit sees 1817 on-chain
anchor events. The ledger accounts for 1816 unique roots; zero
