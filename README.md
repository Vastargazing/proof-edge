...
<!-- generated:headline -->
**3192 forecasts · 1394 on-chain anchors · 3171 public proofs · 0 undisclosed
production roots · Brier skill −0.271 across 7 model versions at N=3177.** The
...
`0.3023`; the market's is `0.2379`. Skill is `−0.2708`, with a deterministic
1,000-resample 95% interval from `−0.3047` to `−0.2365` at `N=3177`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0295` at `N=610`, with an interval from
`−0.0510` to `−0.0075`
...
windows, skill is `−0.2666` at `N=2960`, with a 95% interval from `−0.3004` to
`−0.2318`. Its risk-gate subset is `−0.0300` at `N=558`, with an interval from
`−0.0520` to `−0.0060`
...
At watermark block `477809986`, the audit sees 1395 on-chain
roots, 1394 disclosed roots and zero hidden roots
