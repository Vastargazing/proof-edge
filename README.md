...
<!-- generated:hook -->
Our estimator's Brier loss was 27.3% worse than the market's. We know
...
<!-- generated:headline -->
**3226 forecasts · 1408 on-chain anchors · 3204 public proofs · 0 undisclosed
production roots · Brier skill −0.273 across 7 model versions at N=3210.** The
...
`0.3025`; the market's is `0.2377`. Skill is `−0.2727`, with a deterministic
1,000-resample 95% interval from `−0.3061` to `−0.2388` at `N=3210`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0290` at `N=615`, with an interval from
`−0.0504` to `−0.0066`
...
windows, skill is `−0.2687` at `N=2993`, with a 95% interval from `−0.3038` to
`−0.2346`. Its risk-gate subset is `−0.0296` at `N=563`, with an interval from
`−0.0513` to `−0.0073`
...
At watermark block `477845985`, the audit sees 1409 on-chain
roots, 1408 disclosed roots and zero hidden roots
