...
<!-- generated:headline -->
**4252 forecasts · 1836 disclosed roots · 4235 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4241.** The
...
`0.2996`; the market's is `0.2363`. Skill is `−0.2683`, with a deterministic
1,000-resample 95% interval from `−0.2963` to `−0.2396` at `N=4241`
...
windows, skill is `−0.2650` at `N=4024`, with a 95% interval from `−0.2952` to
`−0.2366`. Its risk-gate subset is `−0.0211` at `N=732`, with an interval from
`−0.0409` to `−0.0012`
...
At watermark block `480905348`, the audit sees 1837 on-chain
anchor events. The ledger accounts for 1836 unique roots; zero
