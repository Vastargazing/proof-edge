...
<!-- generated:headline -->
**380 forecasts · 172 on-chain anchors · 362 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=368.** The
...
`0.3067`; the market's is `0.2426`. Skill is `−0.2644`, with a deterministic
1,000-resample 95% interval from `−0.3702` to `−0.1615` at `N=368`
...
windows, skill is `−0.1792` at `N=151`, with a 95% interval from `−0.3536` to
`−0.0084`. Its risk-gate subset is `−0.0121` at `N=23`, with an interval from
`−0.1305` to `0.1154`
...
At watermark block `473706852`, the audit sees 172 on-chain
roots, 172 disclosed roots and zero hidden roots
