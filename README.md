...
<!-- generated:hook -->
Our estimator's Brier loss was 28.0% worse than the market's. We know
...
<!-- generated:headline -->
**2926 forecasts · 1283 on-chain anchors · 2904 public proofs · 0 undisclosed
production roots · Brier skill −0.280 across 7 model versions at N=2910.** The
...
`0.3057`; the market's is `0.2387`. Skill is `−0.2805`, with a deterministic
1,000-resample 95% interval from `−0.3151` to `−0.2470` at `N=2910`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0294` at `N=567`, with an interval from
`−0.0531` to `−0.0064`
...
windows, skill is `−0.2767` at `N=2693`, with a 95% interval from `−0.3141` to
`−0.2433`. Its risk-gate subset is `−0.0300` at `N=515`, with an interval from
`−0.0525` to `−0.0053`
...
At watermark block `476910119`, the audit sees 1284 on-chain
roots, 1283 disclosed roots and zero hidden roots
