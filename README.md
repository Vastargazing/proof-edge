...
<!-- generated:headline -->
**3048 forecasts · 1334 on-chain anchors · 3026 public proofs · 0 undisclosed
production roots · Brier skill −0.276 across 7 model versions at N=3032.** The
...
`0.3049`; the market's is `0.2390`. Skill is `−0.2758`, with a deterministic
1,000-resample 95% interval from `−0.3075` to `−0.2417` at `N=3032`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0271` at `N=587`, with an interval from
`−0.0489` to `−0.0037`
...
windows, skill is `−0.2718` at `N=2815`, with a 95% interval from `−0.3062` to
`−0.2361`. Its risk-gate subset is `−0.0274` at `N=535`, with an interval from
`−0.0504` to `−0.0039`
...
At watermark block `477594058`, the audit sees 1335 on-chain
roots, 1334 disclosed roots and zero hidden roots
