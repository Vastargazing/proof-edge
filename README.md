...
<!-- generated:headline -->
**398 forecasts · 180 on-chain anchors · 380 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=386.** The
...
`0.3059`; the market's is `0.2419`. Skill is `−0.2646`, with a deterministic
1,000-resample 95% interval from `−0.3708` to `−0.1649` at `N=386`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0209` at `N=77`, with an interval from
`−0.0853` to `0.0416`
...
windows, skill is `−0.1877` at `N=169`, with a 95% interval from `−0.3323` to
`−0.0286`. Its risk-gate subset is `−0.0167` at `N=25`, with an interval from
`−0.1305` to `0.0967`
...
At watermark block `473922803`, the audit sees 180 on-chain
roots, 180 disclosed roots and zero hidden roots
