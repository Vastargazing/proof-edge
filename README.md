...
<!-- generated:headline -->
**4019 forecasts · 1741 disclosed roots · 3997 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4003.** The
...
`0.2993`; the market's is `0.2360`. Skill is `−0.2681`, with a deterministic
1,000-resample 95% interval from `−0.2983` to `−0.2374` at `N=4003`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0212` at `N=736`, with an interval from
`−0.0408` to `−0.0022`
...
windows, skill is `−0.2646` at `N=3786`, with a 95% interval from `−0.2957` to
`−0.2355`. Its risk-gate subset is `−0.0211` at `N=684`, with an interval from
`−0.0414` to `0.0020`
...
At watermark block `478673436`, the audit sees 1742 on-chain
anchor events. The ledger accounts for 1741 unique roots; zero
