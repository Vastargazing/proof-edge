...
<!-- generated:headline -->
**4221 forecasts · 1821 disclosed roots · 4203 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4209.** The
...
`0.2996`; the market's is `0.2362`. Skill is `−0.2681`, with a deterministic
1,000-resample 95% interval from `−0.2979` to `−0.2393` at `N=4209`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0210` at `N=778`, with an interval from
`−0.0396` to `−0.0006`
...
windows, skill is `−0.2648` at `N=3992`, with a 95% interval from `−0.2941` to
`−0.2345`. Its risk-gate subset is `−0.0209` at `N=726`, with an interval from
`−0.0410` to `0.0011`
...
At watermark block `480473450`, the audit sees 1822 on-chain
anchor events. The ledger accounts for 1821 unique roots; zero
