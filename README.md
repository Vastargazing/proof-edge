...
<!-- generated:hook -->
Our estimator's Brier loss was 24.2% worse than the market's. We know
...
<!-- generated:headline -->
**1811 forecasts · 792 on-chain anchors · 1789 public proofs · 0 undisclosed
production roots · Brier skill −0.242 across 7 model versions at N=1795.** The
...
`0.2943`; the market's is `0.2370`. Skill is `−0.2418`, with a deterministic
1,000-resample 95% interval from `−0.2883` to `−0.1968` at `N=1795`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0221` at `N=367`, with an interval from
`−0.0503` to `0.0037`
...
windows, skill is `−0.2300` at `N=1578`, with a 95% interval from `−0.2775` to
`−0.1823`. Its risk-gate subset is `−0.0219` at `N=315`, with an interval from
`−0.0513` to `0.0095`
...
At watermark block `475722491`, the audit sees 793 on-chain
roots, 792 disclosed roots and zero hidden roots
