...
<!-- generated:headline -->
**4229 forecasts · 1823 disclosed roots · 4211 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4217.** The
...
`0.2998`; the market's is `0.2362`. Skill is `−0.2691`, with a deterministic
1,000-resample 95% interval from `−0.2974` to `−0.2384` at `N=4217`
...
windows, skill is `−0.2658` at `N=4000`, with a 95% interval from `−0.2959` to
`−0.2367`. Its risk-gate subset is `−0.0206` at `N=728`, with an interval from
`−0.0401` to `−0.0001`
...
At watermark block `480580759`, the audit sees 1824 on-chain
