...
<!-- generated:headline -->
**4201 forecasts · 1813 disclosed roots · 4187 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4193.** The
...
`0.2999`; the market's is `0.2362`. Skill is `−0.2694`, with a deterministic
1,000-resample 95% interval from `−0.2994` to `−0.2403` at `N=4193`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0221` at `N=773`, with an interval from
`−0.0414` to `−0.0027`
...
windows, skill is `−0.2662` at `N=3976`, with a 95% interval from `−0.2945` to
`−0.2371`. Its risk-gate subset is `−0.0221` at `N=721`, with an interval from
`−0.0422` to `−0.0025`
...
At watermark block `480221035`, the audit sees 1814 on-chain
anchor events. The ledger accounts for 1813 unique roots; zero
