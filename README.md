...
<!-- generated:hook -->
Our estimator's Brier loss was 20.3% worse than the market's. We know
...
<!-- generated:headline -->
**1121 forecasts · 491 on-chain anchors · 1099 public proofs · 0 undisclosed
production roots · Brier skill −0.203 across 7 model versions at N=1105.** The
...
`0.2853`; the market's is `0.2372`. Skill is `−0.2029`, with a deterministic
1,000-resample 95% interval from `−0.2611` to `−0.1471` at `N=1105`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0402` at `N=253`, with an interval from
`−0.0744` to `−0.0046`
...
windows, skill is `−0.1726` at `N=888`, with a 95% interval from `−0.2359` to
`−0.1113`. Its risk-gate subset is `−0.0443` at `N=201`, with an interval from
`−0.0809` to `−0.0058`
...
At watermark block `475002757`, the audit sees 492 on-chain
roots, 491 disclosed roots and zero hidden roots
