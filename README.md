...
<!-- generated:headline -->
**4123 forecasts · 1782 disclosed roots · 4101 public proofs · 0 undisclosed
production roots · Brier skill −0.270 across 7 model versions at N=4107.** The
...
`0.2998`; the market's is `0.2360`. Skill is `−0.2700`, with a deterministic
1,000-resample 95% interval from `−0.2983` to `−0.2408` at `N=4107`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0219` at `N=755`, with an interval from
`−0.0424` to `−0.0015`
...
windows, skill is `−0.2667` at `N=3890`, with a 95% interval from `−0.3005` to
`−0.2338`. Its risk-gate subset is `−0.0218` at `N=703`, with an interval from
`−0.0408` to `−0.0003`
...
At watermark block `478781767`, the audit sees 1783 on-chain
anchor events. The ledger accounts for 1782 unique roots; zero
