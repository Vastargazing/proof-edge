...
<!-- generated:hook -->
My estimator's Brier loss was 26.3% worse than the market's. I know
...
<!-- generated:headline -->
**3605 forecasts · 1564 disclosed roots · 3583 public proofs · 0 undisclosed
production roots · Brier skill −0.263 across 7 model versions at N=3589.** The
...
`0.2981`; the market's is `0.2361`. Skill is `−0.2626`, with a deterministic
1,000-resample 95% interval from `−0.2959` to `−0.2332` at `N=3589`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0217` at `N=687`, with an interval from
`−0.0442` to `−0.0001`
...
windows, skill is `−0.2584` at `N=3372`, with a 95% interval from `−0.2922` to
`−0.2253`. Its risk-gate subset is `−0.0216` at `N=635`, with an interval from
`−0.0426` to `−0.0001`
...
At watermark block `478241886`, the audit sees 1565 on-chain
anchor events. The ledger accounts for 1564 unique roots; zero
