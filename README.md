...
<!-- generated:hook -->
Our estimator's Brier loss was 21.9% worse than the market's. We know
...
<!-- generated:headline -->
**1020 forecasts · 451 on-chain anchors · 998 public proofs · 0 undisclosed
production roots · Brier skill −0.219 across 7 model versions at N=1004.** The
...
`0.2895`; the market's is `0.2374`. Skill is `−0.2191`, with a deterministic
1,000-resample 95% interval from `−0.2798` to `−0.1560` at `N=1004`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0418` at `N=224`, with an interval from
`−0.0749` to `−0.0076`
...
windows, skill is `−0.1893` at `N=787`, with a 95% interval from `−0.2580` to
`−0.1235`. Its risk-gate subset is `−0.0472` at `N=172`, with an interval from
`−0.0845` to `−0.0080`
...
At watermark block `474894587`, the audit sees 452 on-chain
roots, 451 disclosed roots and zero hidden roots
