...
<!-- generated:headline -->
**4328 forecasts · 1872 disclosed roots · 4312 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4318.** The
...
`0.2988`; the market's is `0.2360`. Skill is `−0.2660`, with a deterministic
1,000-resample 95% interval from `−0.2936` to `−0.2376` at `N=4318`
...
windows, skill is `−0.2627` at `N=4101`, with a 95% interval from `−0.2927` to
`−0.2309`. Its risk-gate subset is `−0.0208` at `N=742`, with an interval from
`−0.0420` to `0.0004`
...
At watermark block `481984964`, the audit sees 1873 on-chain
anchor events. The ledger accounts for 1872 unique roots; zero
