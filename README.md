...
<!-- generated:headline -->
**2215 forecasts · 973 on-chain anchors · 2193 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=2199.** The
...
`0.2994`; the market's is `0.2389`. Skill is `−0.2536`, with a deterministic
1,000-resample 95% interval from `−0.2954` to `−0.2128` at `N=2199`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0312` at `N=442`, with an interval from
`−0.0585` to `−0.0066`
...
windows, skill is `−0.2455` at `N=1982`, with a 95% interval from `−0.2856` to
`−0.2052`. Its risk-gate subset is `−0.0322` at `N=390`, with an interval from
`−0.0587` to `−0.0069`
...
At watermark block `476154297`, the audit sees 974 on-chain
roots, 973 disclosed roots and zero hidden roots
