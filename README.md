...
<!-- generated:headline -->
**4324 forecasts · 1871 disclosed roots · 4310 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4316.** The
...
`0.2989`; the market's is `0.2360`. Skill is `−0.2664`, with a deterministic
1,000-resample 95% interval from `−0.2962` to `−0.2363` at `N=4316`
...
windows, skill is `−0.2631` at `N=4099`, with a 95% interval from `−0.2931` to
`−0.2340`. Its risk-gate subset is `−0.0208` at `N=742`, with an interval from
`−0.0420` to `0.0004`
...
At watermark block `481948535`, the audit sees 1872 on-chain
anchor events. The ledger accounts for 1871 unique roots; zero
