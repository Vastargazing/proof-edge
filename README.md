...
<!-- generated:hook -->
Our estimator's Brier loss was 27.4% worse than the market's. We know
...
<!-- generated:headline -->
**3152 forecasts · 1377 on-chain anchors · 3130 public proofs · 0 undisclosed
production roots · Brier skill −0.274 across 7 model versions at N=3136.** The
...
`0.3027`; the market's is `0.2376`. Skill is `−0.2739`, with a deterministic
1,000-resample 95% interval from `−0.3096` to `−0.2439` at `N=3136`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0288` at `N=606`, with an interval from
`−0.0495` to `−0.0064`
...
windows, skill is `−0.2698` at `N=2919`, with a 95% interval from `−0.3044` to
`−0.2365`. Its risk-gate subset is `−0.0293` at `N=554`, with an interval from
`−0.0517` to `−0.0064`
...
At watermark block `477701774`, the audit sees 1378 on-chain
roots, 1377 disclosed roots and zero hidden roots
