...
<!-- generated:hook -->
My estimator's Brier loss was 26.0% worse than the market's. I know
...
<!-- generated:headline -->
**3500 forecasts · 1522 disclosed roots · 3478 public proofs · 0 undisclosed
production roots · Brier skill −0.260 across 7 model versions at N=3484.** The
...
`0.2983`; the market's is `0.2368`. Skill is `−0.2596`, with a deterministic
1,000-resample 95% interval from `−0.2895` to `−0.2292` at `N=3484`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0229` at `N=668`, with an interval from
`−0.0440` to `−0.0015`
...
windows, skill is `−0.2550` at `N=3267`, with a 95% interval from `−0.2886` to
`−0.2216`. Its risk-gate subset is `−0.0229` at `N=616`, with an interval from
`−0.0453` to `0.0011`
...
At watermark block `478133410`, the audit sees 1523 on-chain
anchor events. The ledger accounts for 1522 unique roots; zero
