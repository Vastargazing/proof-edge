...
<!-- generated:hook -->
Our estimator's Brier loss was 26.8% worse than the market's. We know
...
<!-- generated:headline -->
**2615 forecasts · 1152 on-chain anchors · 2593 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=2599.** The
...
`0.3008`; the market's is `0.2372`. Skill is `−0.2680`, with a deterministic
1,000-resample 95% interval from `−0.3059` to `−0.2319` at `N=2599`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0323` at `N=521`, with an interval from
`−0.0556` to `−0.0083`
...
windows, skill is `−0.2625` at `N=2382`, with a 95% interval from `−0.3008` to
`−0.2235`. Its risk-gate subset is `−0.0332` at `N=469`, with an interval from
`−0.0563` to `−0.0084`
...
At watermark block `476586208`, the audit sees 1153 on-chain
roots, 1152 disclosed roots and zero hidden roots
