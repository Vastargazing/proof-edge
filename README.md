...
<!-- generated:hook -->
Our estimator's Brier loss was 21.2% worse than the market's. We know
...
<!-- generated:headline -->
**1328 forecasts · 576 on-chain anchors · 1306 public proofs · 0 undisclosed
production roots · Brier skill −0.212 across 7 model versions at N=1312.** The
...
`0.2881`; the market's is `0.2378`. Skill is `−0.2116`, with a deterministic
1,000-resample 95% interval from `−0.2596` to `−0.1579` at `N=1312`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0388` at `N=305`, with an interval from
`−0.0672` to `−0.0074`
...
windows, skill is `−0.1887` at `N=1095`, with a 95% interval from `−0.2429` to
`−0.1360`. Its risk-gate subset is `−0.0418` at `N=253`, with an interval from
`−0.0767` to `−0.0065`
...
At watermark block `475218500`, the audit sees 577 on-chain
roots, 576 disclosed roots and zero hidden roots
