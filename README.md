...
<!-- generated:hook -->
My estimator's Brier loss was 26.5% worse than the market's. I know
...
<!-- generated:headline -->
**3777 forecasts · 1635 disclosed roots · 3755 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=3761.** The
...
`0.2994`; the market's is `0.2367`. Skill is `−0.2652`, with a deterministic
1,000-resample 95% interval from `−0.2961` to `−0.2367` at `N=3761`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0198` at `N=706`, with an interval from
`−0.0421` to `0.0006`
...
windows, skill is `−0.2613` at `N=3544`, with a 95% interval from `−0.2949` to
`−0.2291`. Its risk-gate subset is `−0.0195` at `N=654`, with an interval from
`−0.0404` to `0.0032`
...
At watermark block `478421621`, the audit sees 1636 on-chain
anchor events. The ledger accounts for 1635 unique roots; zero
