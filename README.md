...
<!-- generated:headline -->
**777 forecasts · 346 on-chain anchors · 755 public proofs · 0 undisclosed
production roots · Brier skill −0.235 across 7 model versions at N=761.** The
...
`0.2953`; the market's is `0.2390`. Skill is `−0.2355`, with a deterministic
1,000-resample 95% interval from `−0.3060` to `−0.1662` at `N=761`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0311` at `N=160`, with an interval from
`−0.0726` to `0.0122`
...
windows, skill is `−0.1992` at `N=544`, with a 95% interval from `−0.2809` to
`−0.1144`. Its risk-gate subset is `−0.0346` at `N=108`, with an interval from
`−0.0858` to `0.0137`
...
At watermark block `474642637`, the audit sees 347 on-chain
roots, 346 disclosed roots and zero hidden roots
