...
<!-- generated:headline -->
**4231 forecasts · 1825 disclosed roots · 4213 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4219.** The
...
`0.2996`; the market's is `0.2362`. Skill is `−0.2686`, with a deterministic
1,000-resample 95% interval from `−0.2978` to `−0.2389` at `N=4219`
...
windows, skill is `−0.2653` at `N=4002`, with a 95% interval from `−0.2971` to
`−0.2358`. Its risk-gate subset is `−0.0206` at `N=728`, with an interval from
`−0.0401` to `−0.0001`
...
At watermark block `480617411`, the audit sees 1826 on-chain
anchor events. The ledger accounts for 1825 unique roots; zero
