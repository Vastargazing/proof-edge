...
<!-- generated:headline -->
**4322 forecasts · 1870 disclosed roots · 4306 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=4312.** The
...
`0.2986`; the market's is `0.2360`. Skill is `−0.2654`, with a deterministic
1,000-resample 95% interval from `−0.2944` to `−0.2358` at `N=4312`
...
windows, skill is `−0.2621` at `N=4095`, with a 95% interval from `−0.2917` to
...
At watermark block `481913135`, the audit sees 1871 on-chain
anchor events. The ledger accounts for 1870 unique roots; zero
