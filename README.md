...
<!-- generated:headline -->
**2851 forecasts · 1254 on-chain anchors · 2835 public proofs · 0 undisclosed
production roots · Brier skill −0.279 across 7 model versions at N=2841.** The
...
`0.3044`; the market's is `0.2380`. Skill is `−0.2789`, with a deterministic
1,000-resample 95% interval from `−0.3157` to `−0.2454` at `N=2841`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0298` at `N=558`, with an interval from
`−0.0526` to `−0.0085`
...
windows, skill is `−0.2748` at `N=2624`, with a 95% interval from `−0.3119` to
`−0.2391`. Its risk-gate subset is `−0.0305` at `N=506`, with an interval from
`−0.0549` to `−0.0059`
...
At watermark block `476838159`, the audit sees 1255 on-chain
roots, 1254 disclosed roots and zero hidden roots
