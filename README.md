...
<!-- generated:headline -->
**4320 forecasts · 1869 disclosed roots · 4304 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=4310.** The
...
`0.2983`; the market's is `0.2359`. Skill is `−0.2644`, with a deterministic
1,000-resample 95% interval from `−0.2924` to `−0.2367` at `N=4310`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0210` at `N=794`, with an interval from
`−0.0393` to `−0.0020`
...
windows, skill is `−0.2610` at `N=4093`, with a 95% interval from `−0.2902` to
`−0.2318`. Its risk-gate subset is `−0.0208` at `N=742`, with an interval from
`−0.0420` to `0.0004`
...
At watermark block `481876541`, the audit sees 1870 on-chain
anchor events. The ledger accounts for 1869 unique roots; zero
