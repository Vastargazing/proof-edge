...
<!-- generated:headline -->
**4227 forecasts · 1823 disclosed roots · 4209 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4215.** The
...
`0.2997`; the market's is `0.2362`. Skill is `−0.2688`, with a deterministic
1,000-resample 95% interval from `−0.2983` to `−0.2387` at `N=4215`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0207` at `N=780`, with an interval from
`−0.0408` to `−0.0016`
...
windows, skill is `−0.2655` at `N=3998`, with a 95% interval from `−0.2966` to
`−0.2369`. Its risk-gate subset is `−0.0206` at `N=728`, with an interval from
`−0.0401` to `−0.0001`
...
At watermark block `480545430`, the audit sees 1824 on-chain
anchor events. The ledger accounts for 1823 unique roots; zero
