...
<!-- generated:hook -->
Our estimator's Brier loss was 21.8% worse than the market's. We know
...
<!-- generated:headline -->
**1258 forecasts · 547 on-chain anchors · 1236 public proofs · 0 undisclosed
production roots · Brier skill −0.218 across 7 model versions at N=1242.** The
...
`0.2899`; the market's is `0.2380`. Skill is `−0.2177`, with a deterministic
1,000-resample 95% interval from `−0.2665` to `−0.1677` at `N=1242`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0397` at `N=291`, with an interval from
`−0.0698` to `−0.0080`
...
windows, skill is `−0.1946` at `N=1025`, with a 95% interval from `−0.2512` to
`−0.1347`. Its risk-gate subset is `−0.0430` at `N=239`, with an interval from
`−0.0765` to `−0.0121`
...
At watermark block `475146617`, the audit sees 548 on-chain
roots, 547 disclosed roots and zero hidden roots
