...
<!-- generated:headline -->
**4235 forecasts · 1827 disclosed roots · 4217 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4223.** The
...
`0.2995`; the market's is `0.2361`. Skill is `−0.2681`, with a deterministic
1,000-resample 95% interval from `−0.2967` to `−0.2398` at `N=4223`
...
windows, skill is `−0.2648` at `N=4006`, with a 95% interval from `−0.2970` to
`−0.2361`. Its risk-gate subset is `−0.0206` at `N=728`, with an interval from
`−0.0401` to `−0.0001`
...
At watermark block `480653402`, the audit sees 1828 on-chain
anchor events. The ledger accounts for 1827 unique roots; zero
