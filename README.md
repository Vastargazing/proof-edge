...
<!-- generated:hook -->
Our estimator's Brier loss was 25.3% worse than the market's. We know
...
<!-- generated:headline -->
**2053 forecasts · 900 on-chain anchors · 2031 public proofs · 0 undisclosed
production roots · Brier skill −0.253 across 7 model versions at N=2037.** The
...
`0.2977`; the market's is `0.2376`. Skill is `−0.2531`, with a deterministic
1,000-resample 95% interval from `−0.2984` to `−0.2116` at `N=2037`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0274` at `N=408`, with an interval from
`−0.0537` to `−0.0015`
...
windows, skill is `−0.2441` at `N=1820`, with a 95% interval from `−0.2875` to
`−0.1984`. Its risk-gate subset is `−0.0280` at `N=356`, with an interval from
`−0.0569` to `0.0027`
...
At watermark block `475974248`, the audit sees 901 on-chain
roots, 900 disclosed roots and zero hidden roots
