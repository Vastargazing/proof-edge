...
<!-- generated:headline -->
**4289 forecasts · 1854 disclosed roots · 4273 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=4279.** The
...
`0.2986`; the market's is `0.2362`. Skill is `−0.2646`, with a deterministic
1,000-resample 95% interval from `−0.2951` to `−0.2377` at `N=4279`
...
windows, skill is `−0.2612` at `N=4062`, with a 95% interval from `−0.2894` to
`−0.2318`. Its risk-gate subset is `−0.0213` at `N=739`, with an interval from
`−0.0418` to `−0.0014`
...
At watermark block `481444956`, the audit sees 1855 on-chain
anchor events. The ledger accounts for 1854 unique roots; zero
