...
<!-- generated:hook -->
Our estimator's Brier loss was 25.9% worse than the market's. We know
...
<!-- generated:headline -->
**390 forecasts · 176 on-chain anchors · 372 public proofs · 0 undisclosed
production roots · Brier skill −0.259 across 7 model versions at N=378.** The
...
`0.3056`; the market's is `0.2427`. Skill is `−0.2594`, with a deterministic
1,000-resample 95% interval from `−0.3607` to `−0.1629` at `N=378`
...
windows, skill is `−0.1730` at `N=161`, with a 95% interval from `−0.3308` to
`−0.0065`. Its risk-gate subset is `−0.0121` at `N=23`, with an interval from
`−0.1305` to `0.1154`
...
At watermark block `473850817`, the audit sees 176 on-chain
roots, 176 disclosed roots and zero hidden roots
