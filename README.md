...
<!-- generated:hook -->
My estimator's Brier loss was 27.0% worse than the market's. I know
...
<!-- generated:headline -->
**3324 forecasts · 1446 disclosed roots · 3308 public proofs · 0 undisclosed
production roots · Brier skill −0.270 across 7 model versions at N=3314.** The
...
`0.3018`; the market's is `0.2375`. Skill is `−0.2704`, with a deterministic
1,000-resample 95% interval from `−0.3030` to `−0.2364` at `N=3314`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0292` at `N=631`, with an interval from
`−0.0518` to `−0.0079`
...
windows, skill is `−0.2663` at `N=3097`, with a 95% interval from `−0.3017` to
`−0.2308`. Its risk-gate subset is `−0.0297` at `N=579`, with an interval from
`−0.0510` to `−0.0056`
...
At watermark block `477953434`, the audit sees 1447 on-chain
anchor events. The ledger accounts for 1446 unique roots; zero
