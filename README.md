...
<!-- generated:headline -->
**3177 forecasts · 1388 on-chain anchors · 3163 public proofs · 0 undisclosed
production roots · Brier skill −0.271 across 7 model versions at N=3169.** The
...
`0.3025`; the market's is `0.2380`. Skill is `−0.2709`, with a deterministic
1,000-resample 95% interval from `−0.3018` to `−0.2381` at `N=3169`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0290` at `N=609`, with an interval from
`−0.0498` to `−0.0075`
...
windows, skill is `−0.2667` at `N=2952`, with a 95% interval from `−0.3006` to
`−0.2322`. Its risk-gate subset is `−0.0296` at `N=557`, with an interval from
`−0.0512` to `−0.0063`
...
At watermark block `477773989`, the audit sees 1389 on-chain
roots, 1388 disclosed roots and zero hidden roots
