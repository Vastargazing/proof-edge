...
<!-- generated:headline -->
**3432 forecasts · 1490 disclosed roots · 3410 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=3416.** The
...
`0.2990`; the market's is `0.2364`. Skill is `−0.2648`, with a deterministic
1,000-resample 95% interval from `−0.2950` to `−0.2314` at `N=3416`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0244` at `N=661`, with an interval from
`−0.0438` to `−0.0028`
...
windows, skill is `−0.2604` at `N=3199`, with a 95% interval from `−0.2926` to
`−0.2281`. Its risk-gate subset is `−0.0245` at `N=609`, with an interval from
`−0.0463` to `−0.0027`
...
At watermark block `478062019`, the audit sees 1491 on-chain
anchor events. The ledger accounts for 1490 unique roots; zero
