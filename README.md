...
<!-- generated:headline -->
**4298 forecasts · 1859 disclosed roots · 4280 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=4286.** The
...
`0.2984`; the market's is `0.2360`. Skill is `−0.2643`, with a deterministic
1,000-resample 95% interval from `−0.2938` to `−0.2354` at `N=4286`
...
windows, skill is `−0.2609` at `N=4069`, with a 95% interval from `−0.2903` to
`−0.2320`. Its risk-gate subset is `−0.0213` at `N=739`, with an interval from
`−0.0418` to `−0.0014`
...
At watermark block `481553218`, the audit sees 1860 on-chain
anchor events. The ledger accounts for 1859 unique roots; zero
