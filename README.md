...
<!-- generated:hook -->
Our estimator's Brier loss was 25.4% worse than the market's. We know
...
<!-- generated:headline -->
**1915 forecasts · 839 on-chain anchors · 1893 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=1899.** The
...
`0.2978`; the market's is `0.2375`. Skill is `−0.2539`, with a deterministic
1,000-resample 95% interval from `−0.2979` to `−0.2118` at `N=1899`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0251` at `N=388`, with an interval from
`−0.0517` to `0.0024`
...
windows, skill is `−0.2444` at `N=1682`, with a 95% interval from `−0.2903` to
`−0.1991`. Its risk-gate subset is `−0.0254` at `N=336`, with an interval from
`−0.0517` to `0.0050`
...
At watermark block `475830373`, the audit sees 840 on-chain
roots, 839 disclosed roots and zero hidden roots
