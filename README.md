...
<!-- generated:hook -->
Our estimator's Brier loss was 26.9% worse than the market's. We know
...
<!-- generated:headline -->
**418 forecasts · 190 on-chain anchors · 400 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=406.** The
...
`0.3066`; the market's is `0.2417`. Skill is `−0.2685`, with a deterministic
1,000-resample 95% interval from `−0.3644` to `−0.1660` at `N=406`
...
windows, skill is `−0.2036` at `N=189`, with a 95% interval from `−0.3559` to
`−0.0553`. Its risk-gate subset is `−0.0240` at `N=30`, with an interval from
`−0.1251` to `0.0646`
...
At watermark block `474210727`, the audit sees 190 on-chain
roots, 190 disclosed roots and zero hidden roots
