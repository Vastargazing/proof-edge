...
<!-- generated:headline -->
**3847 forecasts · 1664 disclosed roots · 3825 public proofs · 0 undisclosed
production roots · Brier skill −0.271 across 7 model versions at N=3831.** The
...
`0.3008`; the market's is `0.2366`. Skill is `−0.2712`, with a deterministic
1,000-resample 95% interval from `−0.3015` to `−0.2410` at `N=3831`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0209` at `N=715`, with an interval from
`−0.0416` to `−0.0001`
...
windows, skill is `−0.2677` at `N=3614`, with a 95% interval from `−0.2980` to
`−0.2364`. Its risk-gate subset is `−0.0208` at `N=663`, with an interval from
`−0.0412` to `0.0018`
...
At watermark block `478494089`, the audit sees 1665 on-chain
anchor events. The ledger accounts for 1664 unique roots; zero
