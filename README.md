...
<!-- generated:headline -->
**2980 forecasts · 1303 on-chain anchors · 2958 public proofs · 0 undisclosed
production roots · Brier skill −0.278 across 7 model versions at N=2964.** The
...
`0.3054`; the market's is `0.2390`. Skill is `−0.2781`, with a deterministic
1,000-resample 95% interval from `−0.3164` to `−0.2465` at `N=2964`
...
windows, skill is `−0.2742` at `N=2747`, with a 95% interval from `−0.3097` to
`−0.2375`. Its risk-gate subset is `−0.0278` at `N=525`, with an interval from
`−0.0516` to `−0.0049`
...
At watermark block `477521473`, the audit sees 1303 on-chain
roots, 1302 disclosed roots and zero hidden roots
