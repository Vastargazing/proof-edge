...
<!-- generated:hook -->
My estimator's Brier loss was 26.1% worse than the market's. I know
...
<!-- generated:headline -->
**3534 forecasts · 1538 disclosed roots · 3512 public proofs · 0 undisclosed
production roots · Brier skill −0.261 across 7 model versions at N=3518.** The
...
`0.2978`; the market's is `0.2362`. Skill is `−0.2606`, with a deterministic
1,000-resample 95% interval from `−0.2918` to `−0.2251` at `N=3518`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0224` at `N=679`, with an interval from
`−0.0440` to `−0.0011`
...
windows, skill is `−0.2561` at `N=3301`, with a 95% interval from `−0.2872` to
`−0.2212`. Its risk-gate subset is `−0.0223` at `N=627`, with an interval from
`−0.0441` to `0.0012`
...
At watermark block `478169902`, the audit sees 1539 on-chain
anchor events. The ledger accounts for 1538 unique roots; zero
