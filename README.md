...
<!-- generated:hook -->
Our estimator's Brier loss was 26.5% worse than the market's. We know
...
<!-- generated:headline -->
**2517 forecasts · 1107 on-chain anchors · 2495 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=2501.** The
...
`0.2995`; the market's is `0.2367`. Skill is `−0.2655`, with a deterministic
1,000-resample 95% interval from `−0.3011` to `−0.2291` at `N=2501`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0327` at `N=507`, with an interval from
`−0.0588` to `−0.0088`
...
windows, skill is `−0.2595` at `N=2284`, with a 95% interval from `−0.2995` to
`−0.2194`. Its risk-gate subset is `−0.0338` at `N=455`, with an interval from
`−0.0589` to `−0.0090`
...
At watermark block `476478489`, the audit sees 1108 on-chain
roots, 1107 disclosed roots and zero hidden roots
