...
<!-- generated:headline -->
**2651 forecasts · 1167 on-chain anchors · 2629 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=2635.** The
...
`0.3008`; the market's is `0.2372`. Skill is `−0.2681`, with a deterministic
1,000-resample 95% interval from `−0.3049` to `−0.2298` at `N=2635`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0315` at `N=528`, with an interval from
`−0.0555` to `−0.0084`
...
windows, skill is `−0.2627` at `N=2418`, with a 95% interval from `−0.3021` to
`−0.2250`. Its risk-gate subset is `−0.0324` at `N=476`, with an interval from
`−0.0541` to `−0.0088`
...
At watermark block `476622204`, the audit sees 1168 on-chain
roots, 1167 disclosed roots and zero hidden roots
