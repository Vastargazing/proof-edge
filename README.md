...
<!-- generated:hook -->
Our estimator's Brier loss was 24.4% worse than the market's. We know
...
<!-- generated:headline -->
**1432 forecasts · 624 on-chain anchors · 1410 public proofs · 0 undisclosed
production roots · Brier skill −0.244 across 7 model versions at N=1416.** The
...
`0.2970`; the market's is `0.2387`. Skill is `−0.2443`, with a deterministic
1,000-resample 95% interval from `−0.2967` to `−0.1964` at `N=1416`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0392` at `N=309`, with an interval from
`−0.0679` to `−0.0095`
...
windows, skill is `−0.2293` at `N=1199`, with a 95% interval from `−0.2803` to
`−0.1748`. Its risk-gate subset is `−0.0422` at `N=257`, with an interval from
`−0.0743` to `−0.0084`
...
At watermark block `475326520`, the audit sees 624 on-chain
roots, 623 disclosed roots and zero hidden roots
