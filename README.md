...
<!-- generated:headline -->
**4437 forecasts · 1926 disclosed roots · 4415 public proofs · 0 undisclosed
production roots · Brier skill −0.263 across 7 model versions at N=4421.** The
...
`0.2967`; the market's is `0.2349`. Skill is `−0.2631`, with a deterministic
1,000-resample 95% interval from `−0.2934` to `−0.2331` at `N=4421`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0199` at `N=823`, with an interval from
`−0.0381` to `0.0001`
...
windows, skill is `−0.2597` at `N=4204`, with a 95% interval from `−0.2901` to
`−0.2300`. Its risk-gate subset is `−0.0197` at `N=771`, with an interval from
`−0.0394` to `−0.0009`
...
At watermark block `482488933`, the audit sees 1927 on-chain
anchor events. The ledger accounts for 1926 unique roots; zero
