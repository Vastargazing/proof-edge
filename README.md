...
<!-- generated:headline -->
**3639 forecasts · 1578 disclosed roots · 3617 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=3623.** The
...
1,000-resample 95% interval from `−0.2986` to `−0.2355` at `N=3623`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0214` at `N=694`, with an interval from
`−0.0420` to `−0.0015`
...
windows, skill is `−0.2625` at `N=3406`, with a 95% interval from `−0.2959` to
`−0.2322`. Its risk-gate subset is `−0.0213` at `N=642`, with an interval from
`−0.0432` to `0.0025`
...
At watermark block `478277976`, the audit sees 1579 on-chain
anchor events. The ledger accounts for 1578 unique roots; zero
