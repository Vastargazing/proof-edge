...
<!-- generated:headline -->
**1847 forecasts · 808 on-chain anchors · 1825 public proofs · 0 undisclosed
production roots · Brier skill −0.242 across 7 model versions at N=1831.** The
...
`0.2942`; the market's is `0.2369`. Skill is `−0.2416`, with a deterministic
1,000-resample 95% interval from `−0.2891` to `−0.1982` at `N=1831`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0225` at `N=378`, with an interval from
`−0.0532` to `0.0083`
...
windows, skill is `−0.2299` at `N=1614`, with a 95% interval from `−0.2749` to
`−0.1829`. Its risk-gate subset is `−0.0225` at `N=326`, with an interval from
`−0.0523` to `0.0045`
...
At watermark block `475758382`, the audit sees 809 on-chain
roots, 808 disclosed roots and zero hidden roots
