...
<!-- generated:headline -->
**4648 forecasts · 2018 disclosed roots · 4634 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=4640.** The
...
`0.2929`; the market's is `0.2336`. Skill is `−0.2542`, with a deterministic
1,000-resample 95% interval from `−0.2819` to `−0.2266` at `N=4640`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0168` at `N=865`, with an interval from
`−0.0348` to `0.0021`
...
windows, skill is `−0.2505` at `N=4423`, with a 95% interval from `−0.2797` to
`−0.2206`. Its risk-gate subset is `−0.0164` at `N=813`, with an interval from
`−0.0348` to `0.0016`
...
At watermark block `482812913`, the audit sees 2019 on-chain
anchor events. The ledger accounts for 2018 unique roots; zero
