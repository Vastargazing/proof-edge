...
<!-- generated:hook -->
Our estimator's Brier loss was 25.5% worse than the market's. We know
...
<!-- generated:headline -->
**1949 forecasts · 854 on-chain anchors · 1927 public proofs · 0 undisclosed
production roots · Brier skill −0.255 across 7 model versions at N=1933.** The
...
`0.2982`; the market's is `0.2375`. Skill is `−0.2553`, with a deterministic
1,000-resample 95% interval from `−0.2989` to `−0.2110` at `N=1933`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0256` at `N=394`, with an interval from
`−0.0543` to `0.0015`
...
windows, skill is `−0.2461` at `N=1716`, with a 95% interval from `−0.2890` to
`−0.1979`. Its risk-gate subset is `−0.0260` at `N=342`, with an interval from
`−0.0544` to `0.0026`
...
At watermark block `475866458`, the audit sees 855 on-chain
roots, 854 disclosed roots and zero hidden roots
