...
<!-- generated:headline -->
**4225 forecasts · 1822 disclosed roots · 4207 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4213.** The
...
`0.2998`; the market's is `0.2363`. Skill is `−0.2688`, with a deterministic
1,000-resample 95% interval from `−0.2991` to `−0.2375` at `N=4213`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0206` at `N=779`, with an interval from
`−0.0403` to `−0.0015`
...
windows, skill is `−0.2656` at `N=3996`, with a 95% interval from `−0.2955` to
`−0.2343`. Its risk-gate subset is `−0.0204` at `N=727`, with an interval from
`−0.0404` to `−0.0007`
...
At watermark block `480509438`, the audit sees 1823 on-chain
anchor events. The ledger accounts for 1822 unique roots; zero
