...
<!-- generated:headline -->
**384 forecasts · 173 on-chain anchors · 366 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=372.** The
...
`0.3040`; the market's is `0.2425`. Skill is `−0.2537`, with a deterministic
1,000-resample 95% interval from `−0.3586` to `−0.1529` at `N=372`
...
windows, skill is `−0.1568` at `N=155`, with a 95% interval from `−0.3240` to
`0.0012`. Its risk-gate subset is `−0.0121` at `N=23`, with an interval from
`−0.1305` to `0.1154`
...
At watermark block `473742887`, the audit sees 173 on-chain
roots, 173 disclosed roots and zero hidden roots
