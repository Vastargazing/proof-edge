...
<!-- generated:headline -->
**916 forecasts · 403 on-chain anchors · 894 public proofs · 0 undisclosed
production roots · Brier skill −0.243 across 7 model versions at N=900.** The
...
`0.2974`; the market's is `0.2393`. Skill is `−0.2427`, with a deterministic
1,000-resample 95% interval from `−0.3066` to `−0.1786` at `N=900`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0324` at `N=200`, with an interval from
`−0.0708` to `0.0046`
...
windows, skill is `−0.2161` at `N=683`, with a 95% interval from `−0.2916` to
`−0.1402`. Its risk-gate subset is `−0.0354` at `N=148`, with an interval from
`−0.0785` to `0.0029`
...
At watermark block `474786710`, the audit sees 404 on-chain
roots, 403 disclosed roots and zero hidden roots
