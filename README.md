...
<!-- generated:headline -->
**2175 forecasts · 958 on-chain anchors · 2159 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=2165.** The
...
`0.2990`; the market's is `0.2385`. Skill is `−0.2538`, with a deterministic
1,000-resample 95% interval from `−0.2933` to `−0.2153` at `N=2165`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0334` at `N=434`, with an interval from
`−0.0583` to `−0.0084`
...
windows, skill is `−0.2456` at `N=1948`, with a 95% interval from `−0.2905` to
`−0.2029`. Its risk-gate subset is `−0.0347` at `N=382`, with an interval from
`−0.0600` to `−0.0066`
...
At watermark block `476117875`, the audit sees 959 on-chain
roots, 958 disclosed roots and zero hidden roots
