...
<!-- generated:hook -->
Our estimator's Brier loss was 26.1% worse than the market's. We know
...
<!-- generated:headline -->
**2272 forecasts · 999 on-chain anchors · 2256 public proofs · 0 undisclosed
production roots · Brier skill −0.261 across 7 model versions at N=2262.** The
...
`0.3015`; the market's is `0.2391`. Skill is `−0.2608`, with a deterministic
1,000-resample 95% interval from `−0.2965` to `−0.2212` at `N=2262`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0321` at `N=454`, with an interval from
`−0.0575` to `−0.0056`
...
windows, skill is `−0.2537` at `N=2045`, with a 95% interval from `−0.2941` to
`−0.2133`. Its risk-gate subset is `−0.0331` at `N=402`, with an interval from
`−0.0610` to `−0.0069`
...
At watermark block `476226378`, the audit sees 1000 on-chain
roots, 999 disclosed roots and zero hidden roots
