...
<!-- generated:headline -->
**4644 forecasts · 2015 disclosed roots · 4628 public proofs · 0 undisclosed
production roots · Brier skill −0.254 across 7 model versions at N=4634.** The
...
`0.2931`; the market's is `0.2338`. Skill is `−0.2539`, with a deterministic
1,000-resample 95% interval from `−0.2820` to `−0.2265` at `N=4634`
...
windows, skill is `−0.2502` at `N=4417`, with a 95% interval from `−0.2781` to
`−0.2209`. Its risk-gate subset is `−0.0167` at `N=810`, with an interval from
`−0.0363` to `0.0029`
...
At watermark block `482740702`, the audit sees 2016 on-chain
anchor events. The ledger accounts for 2015 unique roots; zero
