...
<!-- generated:hook -->
Our estimator's Brier loss was 25.0% worse than the market's. We know
...
<!-- generated:headline -->
**1637 forecasts · 713 on-chain anchors · 1615 public proofs · 0 undisclosed
production roots · Brier skill −0.250 across 7 model versions at N=1621.** The
...
`0.2962`; the market's is `0.2371`. Skill is `−0.2495`, with a deterministic
1,000-resample 95% interval from `−0.2944` to `−0.2003` at `N=1621`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0341` at `N=342`, with an interval from
`−0.0623` to `−0.0042`
...
windows, skill is `−0.2374` at `N=1404`, with a 95% interval from `−0.2924` to
`−0.1895`. Its risk-gate subset is `−0.0359` at `N=290`, with an interval from
`−0.0677` to `−0.0066`
...
At watermark block `475542537`, the audit sees 713 on-chain
roots, 712 disclosed roots and zero hidden roots
