...
<!-- generated:headline -->
**2077 forecasts · 911 on-chain anchors · 2061 public proofs · 0 undisclosed
production roots · Brier skill −0.248 across 7 model versions at N=2067.** The
...
`0.2967`; the market's is `0.2377`. Skill is `−0.2482`, with a deterministic
1,000-resample 95% interval from `−0.2884` to `−0.2053` at `N=2067`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0290` at `N=413`, with an interval from
`−0.0551` to `−0.0028`
...
windows, skill is `−0.2389` at `N=1850`, with a 95% interval from `−0.2804` to
`−0.1924`. Its risk-gate subset is `−0.0298` at `N=361`, with an interval from
`−0.0590` to `−0.0013`
...
At watermark block `476010341`, the audit sees 912 on-chain
roots, 911 disclosed roots and zero hidden roots
