...
<!-- generated:headline -->
**4271 forecasts · 1846 disclosed roots · 4253 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4259.** The
...
`0.2990`; the market's is `0.2361`. Skill is `−0.2661`, with a deterministic
1,000-resample 95% interval from `−0.2947` to `−0.2374` at `N=4259`
...
windows, skill is `−0.2628` at `N=4042`, with a 95% interval from `−0.2935` to
`−0.2323`. Its risk-gate subset is `−0.0215` at `N=736`, with an interval from
`−0.0411` to `−0.0016`
...
At watermark block `481156699`, the audit sees 1847 on-chain
anchor events. The ledger accounts for 1846 unique roots; zero
