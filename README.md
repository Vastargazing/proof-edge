...
<!-- generated:hook -->
My estimator's Brier loss was 27.2% worse than the market's. I know
...
<!-- generated:headline -->
**3881 forecasts · 1677 disclosed roots · 3859 public proofs · 0 undisclosed
production roots · Brier skill −0.272 across 7 model versions at N=3865.** The
...
`0.3012`; the market's is `0.2368`. Skill is `−0.2721`, with a deterministic
1,000-resample 95% interval from `−0.3030` to `−0.2425` at `N=3865`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0205` at `N=719`, with an interval from
`−0.0415` to `0.0005`
...
windows, skill is `−0.2687` at `N=3648`, with a 95% interval from `−0.3004` to
`−0.2398`. Its risk-gate subset is `−0.0203` at `N=667`, with an interval from
`−0.0418` to `0.0012`
...
At watermark block `478529562`, the audit sees 1678 on-chain
anchor events. The ledger accounts for 1677 unique roots; zero
