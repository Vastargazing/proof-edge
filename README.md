...
<!-- generated:headline -->
**4404 forecasts · 1911 disclosed roots · 4382 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4388.** The
...
`0.2977`; the market's is `0.2352`. Skill is `−0.2657`, with a deterministic
1,000-resample 95% interval from `−0.2925` to `−0.2371` at `N=4388`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0199` at `N=814`, with an interval from
`−0.0389` to `−0.0014`
...
windows, skill is `−0.2624` at `N=4171`, with a 95% interval from `−0.2901` to
`−0.2328`. Its risk-gate subset is `−0.0197` at `N=762`, with an interval from
`−0.0391` to `0.0000`
...
At watermark block `482452402`, the audit sees 1912 on-chain
anchor events. The ledger accounts for 1911 unique roots; zero
