...
<!-- generated:headline -->
**400 forecasts · 181 on-chain anchors · 382 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=388.** The
...
`0.3065`; the market's is `0.2420`. Skill is `−0.2664`, with a deterministic
1,000-resample 95% interval from `−0.3625` to `−0.1632` at `N=388`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0227` at `N=78`, with an interval from
`−0.0861` to `0.0392`
...
windows, skill is `−0.1926` at `N=171`, with a 95% interval from `−0.3408` to
`−0.0462`. Its risk-gate subset is `−0.0222` at `N=26`, with an interval from
`−0.1337` to `0.0896`
...
At watermark block `473958845`, the audit sees 181 on-chain
roots, 181 disclosed roots and zero hidden roots
