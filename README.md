...
<!-- generated:headline -->
**4273 forecasts · 1848 disclosed roots · 4259 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=4265.** The
...
`0.2987`; the market's is `0.2361`. Skill is `−0.2654`, with a deterministic
1,000-resample 95% interval from `−0.2960` to `−0.2365` at `N=4265`
...
windows, skill is `−0.2620` at `N=4048`, with a 95% interval from `−0.2928` to
`−0.2314`. Its risk-gate subset is `−0.0216` at `N=738`, with an interval from
`−0.0421` to `−0.0024`
...
At watermark block `481228712`, the audit sees 1849 on-chain
anchor events. The ledger accounts for 1848 unique roots; zero
