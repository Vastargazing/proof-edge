...
<!-- generated:hook -->
Our estimator's Brier loss was 23.7% worse than the market's. We know
...
<!-- generated:headline -->
**1395 forecasts · 605 on-chain anchors · 1374 public proofs · 0 undisclosed
production roots · Brier skill −0.237 across 7 model versions at N=1380.** The
...
`0.2963`; the market's is `0.2396`. Skill is `−0.2367`, with a deterministic
1,000-resample 95% interval from `−0.2861` to `−0.1905` at `N=1380`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0399` at `N=308`, with an interval from
`−0.0698` to `−0.0111`
...
windows, skill is `−0.2200` at `N=1163`, with a 95% interval from `−0.2770` to
`−0.1671`. Its risk-gate subset is `−0.0430` at `N=256`, with an interval from
`−0.0756` to `−0.0089`
...
At watermark block `475290585`, the audit sees 606 on-chain
roots, 605 disclosed roots and zero hidden roots
