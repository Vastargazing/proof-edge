...
<!-- generated:headline -->
**3811 forecasts · 1650 disclosed roots · 3789 public proofs · 0 undisclosed
production roots · Brier skill −0.270 across 7 model versions at N=3795.** The
...
`0.3006`; the market's is `0.2367`. Skill is `−0.2700`, with a deterministic
1,000-resample 95% interval from `−0.3000` to `−0.2400` at `N=3795`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0214` at `N=712`, with an interval from
`−0.0417` to `0.0001`
...
windows, skill is `−0.2664` at `N=3578`, with a 95% interval from `−0.2960` to
`−0.2358`. Its risk-gate subset is `−0.0212` at `N=660`, with an interval from
`−0.0411` to `−0.0001`
...
At watermark block `478458040`, the audit sees 1651 on-chain
anchor events. The ledger accounts for 1650 unique roots; zero
