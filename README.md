...
<!-- generated:headline -->
**2719 forecasts · 1197 on-chain anchors · 2697 public proofs · 0 undisclosed
production roots · Brier skill −0.263 across 7 model versions at N=2703.** The
...
`0.2998`; the market's is `0.2373`. Skill is `−0.2633`, with a deterministic
1,000-resample 95% interval from `−0.2987` to `−0.2303` at `N=2703`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0319` at `N=539`, with an interval from
`−0.0547` to `−0.0074`
...
windows, skill is `−0.2577` at `N=2486`, with a 95% interval from `−0.2943` to
`−0.2190`. Its risk-gate subset is `−0.0327` at `N=487`, with an interval from
`−0.0569` to `−0.0071`
...
At watermark block `476694280`, the audit sees 1198 on-chain
roots, 1197 disclosed roots and zero hidden roots
