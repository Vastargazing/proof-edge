...
<!-- generated:headline -->
**3173 forecasts · 1386 on-chain anchors · 3157 public proofs · 0 undisclosed
production roots · Brier skill −0.273 across 7 model versions at N=3163.** The
...
1,000-resample 95% interval from `−0.3062` to `−0.2376` at `N=3163`
...
windows, skill is `−0.2686` at `N=2946`, with a 95% interval from `−0.3054` to
`−0.2334`. Its risk-gate subset is `−0.0296` at `N=557`, with an interval from
`−0.0512` to `−0.0063`
...
At watermark block `477737994`, the audit sees 1387 on-chain
roots, 1386 disclosed roots and zero hidden roots
