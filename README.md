...
<!-- generated:hook -->
Our estimator's Brier loss was 27.5% worse than the market's. We know
...
<!-- generated:headline -->
**3118 forecasts · 1364 on-chain anchors · 3096 public proofs · 0 undisclosed
production roots · Brier skill −0.275 across 7 model versions at N=3102.** The
...
`0.3036`; the market's is `0.2382`. Skill is `−0.2747`, with a deterministic
1,000-resample 95% interval from `−0.3091` to `−0.2409` at `N=3102`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0266` at `N=599`, with an interval from
`−0.0499` to `−0.0046`
...
windows, skill is `−0.2707` at `N=2885`, with a 95% interval from `−0.3068` to
`−0.2357`. Its risk-gate subset is `−0.0269` at `N=547`, with an interval from
`−0.0502` to `−0.0020`
...
At watermark block `477666016`, the audit sees 1365 on-chain
roots, 1364 disclosed roots and zero hidden roots
