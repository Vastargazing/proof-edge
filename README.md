...
<!-- generated:hook -->
Our estimator's Brier loss was 24.7% worse than the market's. We know
...
<!-- generated:headline -->
**1670 forecasts · 730 on-chain anchors · 1649 public proofs · 0 undisclosed
production roots · Brier skill −0.247 across 7 model versions at N=1655.** The
...
`0.2957`; the market's is `0.2372`. Skill is `−0.2469`, with a deterministic
1,000-resample 95% interval from `−0.2929` to `−0.1978` at `N=1655`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0308` at `N=348`, with an interval from
`−0.0605` to `−0.0014`
...
windows, skill is `−0.2347` at `N=1438`, with a 95% interval from `−0.2822` to
`−0.1889`. Its risk-gate subset is `−0.0321` at `N=296`, with an interval from
`−0.0620` to `0.0007`
...
At watermark block `475578523`, the audit sees 731 on-chain
roots, 730 disclosed roots and zero hidden roots
