...
<!-- generated:headline -->
**378 forecasts · 171 on-chain anchors · 360 public proofs · 0 undisclosed
production roots · Brier skill −0.261 across 7 model versions at N=366.** The
...
`0.3060`; the market's is `0.2426`. Skill is `−0.2613`, with a deterministic
1,000-resample 95% interval from `−0.3621` to `−0.1573` at `N=366`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0141` at `N=74`, with an interval from
`−0.0854` to `0.0502`
...
windows, skill is `−0.1709` at `N=149`, with a 95% interval from `−0.3394` to
`−0.0025`. Its risk-gate subset is `0.0072` at `N=22`, with an interval from
`−0.1102` to `0.1243`
...
At watermark block `473670862`, the audit sees 171 on-chain
roots, 171 disclosed roots and zero hidden roots
