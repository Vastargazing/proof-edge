...
<!-- generated:headline -->
**2019 forecasts · 886 on-chain anchors · 1997 public proofs · 0 undisclosed
production roots · Brier skill −0.252 across 7 model versions at N=2003.** The
...
`0.2969`; the market's is `0.2372`. Skill is `−0.2515`, with a deterministic
1,000-resample 95% interval from `−0.2920` to `−0.2101` at `N=2003`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0252` at `N=401`, with an interval from
`−0.0515` to `0.0023`
...
windows, skill is `−0.2423` at `N=1786`, with a 95% interval from `−0.2870` to
`−0.1983`. Its risk-gate subset is `−0.0256` at `N=349`, with an interval from
`−0.0542` to `0.0034`
...
At watermark block `475938347`, the audit sees 887 on-chain
roots, 886 disclosed roots and zero hidden roots
