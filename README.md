...
<!-- generated:headline -->
**4287 forecasts · 1853 disclosed roots · 4271 public proofs · 0 undisclosed
production roots · Brier skill −0.265 across 7 model versions at N=4277.** The
...
`0.2988`; the market's is `0.2361`. Skill is `−0.2652`, with a deterministic
1,000-resample 95% interval from `−0.2954` to `−0.2351` at `N=4277`
...
windows, skill is `−0.2618` at `N=4060`, with a 95% interval from `−0.2900` to
`−0.2307`. Its risk-gate subset is `−0.0213` at `N=739`, with an interval from
`−0.0418` to `−0.0014`
...
At watermark block `481409249`, the audit sees 1854 on-chain
anchor events. The ledger accounts for 1853 unique roots; zero
