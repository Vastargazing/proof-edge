...
<!-- generated:headline -->
**882 forecasts · 390 on-chain anchors · 860 public proofs · 0 undisclosed
production roots · Brier skill −0.244 across 7 model versions at N=866.** The
...
`0.2985`; the market's is `0.2400`. Skill is `−0.2438`, with a deterministic
1,000-resample 95% interval from `−0.3072` to `−0.1804` at `N=866`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0375` at `N=189`, with an interval from
`−0.0770` to `−0.0005`
...
windows, skill is `−0.2162` at `N=649`, with a 95% interval from `−0.2940` to
`−0.1449`. Its risk-gate subset is `−0.0426` at `N=137`, with an interval from
`−0.0878` to `0.0013`
...
At watermark block `474750614`, the audit sees 391 on-chain
roots, 390 disclosed roots and zero hidden roots
