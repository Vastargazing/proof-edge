...
<!-- generated:headline -->
**4219 forecasts · 1820 disclosed roots · 4201 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4207.** The
...
`0.2997`; the market's is `0.2362`. Skill is `−0.2685`, with a deterministic
1,000-resample 95% interval from `−0.2984` to `−0.2385` at `N=4207`
...
windows, skill is `−0.2652` at `N=3990`, with a 95% interval from `−0.2954` to
`−0.2364`. Its risk-gate subset is `−0.0213` at `N=725`, with an interval from
`−0.0416` to `−0.0013`
...
At watermark block `480437456`, the audit sees 1821 on-chain
anchor events. The ledger accounts for 1820 unique roots; zero
