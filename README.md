...
<!-- generated:headline -->
**4375 forecasts · 1899 disclosed roots · 4359 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4365.** The
...
`0.2980`; the market's is `0.2355`. Skill is `−0.2658`, with a deterministic
1,000-resample 95% interval from `−0.2953` to `−0.2365` at `N=4365`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0210` at `N=810`, with an interval from
`−0.0398` to `−0.0019`
...
windows, skill is `−0.2625` at `N=4148`, with a 95% interval from `−0.2935` to
`−0.2318`. Its risk-gate subset is `−0.0209` at `N=758`, with an interval from
`−0.0405` to `−0.0015`
...
At watermark block `482416414`, the audit sees 1900 on-chain
anchor events. The ledger accounts for 1899 unique roots; zero
