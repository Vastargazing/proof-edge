...
<!-- generated:headline -->
**1500 forecasts · 652 on-chain anchors · 1478 public proofs · 0 undisclosed
production roots · Brier skill −0.248 across 7 model versions at N=1484.** The
...
`0.2987`; the market's is `0.2394`. Skill is `−0.2477`, with a deterministic
1,000-resample 95% interval from `−0.2960` to `−0.2028` at `N=1484`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0383` at `N=321`, with an interval from
`−0.0698` to `−0.0089`
...
windows, skill is `−0.2341` at `N=1267`, with a 95% interval from `−0.2860` to
`−0.1849`. Its risk-gate subset is `−0.0410` at `N=269`, with an interval from
`−0.0719` to `−0.0099`
...
At watermark block `475398567`, the audit sees 653 on-chain
roots, 652 disclosed roots and zero hidden roots
