...
<!-- generated:hook -->
Our estimator's Brier loss was 27.9% worse than the market's. We know
...
<!-- generated:headline -->
**2890 forecasts · 1268 on-chain anchors · 2868 public proofs · 0 undisclosed
production roots · Brier skill −0.279 across 7 model versions at N=2874.** The
...
`0.3047`; the market's is `0.2383`. Skill is `−0.2788`, with a deterministic
1,000-resample 95% interval from `−0.3143` to `−0.2436` at `N=2874`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0294` at `N=564`, with an interval from
`−0.0535` to `−0.0080`
...
windows, skill is `−0.2748` at `N=2657`, with a 95% interval from `−0.3119` to
`−0.2378`. Its risk-gate subset is `−0.0300` at `N=512`, with an interval from
`−0.0543` to `−0.0071`
...
At watermark block `476874230`, the audit sees 1269 on-chain
roots, 1268 disclosed roots and zero hidden roots
