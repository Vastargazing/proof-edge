...
<!-- generated:headline -->
**739 forecasts · 330 on-chain anchors · 721 public proofs · 0 undisclosed
production roots · Brier skill −0.234 across 7 model versions at N=727.** The
...
`0.2948`; the market's is `0.2388`. Skill is `−0.2341`, with a deterministic
1,000-resample 95% interval from `−0.3013` to `−0.1643` at `N=727`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0357` at `N=148`, with an interval from
`−0.0818` to `0.0085`
...
windows, skill is `−0.1949` at `N=510`, with a 95% interval from `−0.2832` to
`−0.1093`. Its risk-gate subset is `−0.0422` at `N=96`, with an interval from
`−0.0944` to `0.0120`
...
At watermark block `474606429`, the audit sees 331 on-chain
roots, 330 disclosed roots and zero hidden roots
