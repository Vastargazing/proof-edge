...
<!-- generated:headline -->
**3571 forecasts · 1550 disclosed roots · 3549 public proofs · 0 undisclosed
production roots · Brier skill −0.263 across 7 model versions at N=3555.** The
...
`0.2983`; the market's is `0.2363`. Skill is `−0.2628`, with a deterministic
1,000-resample 95% interval from `−0.2965` to `−0.2312` at `N=3555`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0225` at `N=682`, with an interval from
`−0.0445` to `−0.0015`
...
windows, skill is `−0.2585` at `N=3338`, with a 95% interval from `−0.2908` to
`−0.2249`. Its risk-gate subset is `−0.0224` at `N=630`, with an interval from
`−0.0432` to `−0.0007`
...
At watermark block `478205893`, the audit sees 1551 on-chain
anchor events. The ledger accounts for 1550 unique roots; zero
