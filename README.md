...
<!-- generated:headline -->
**4507 forecasts · 1956 disclosed roots · 4485 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=4491.** The
...
`0.2969`; the market's is `0.2348`. Skill is `−0.2644`, with a deterministic
1,000-resample 95% interval from `−0.2915` to `−0.2361` at `N=4491`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0206` at `N=832`, with an interval from
`−0.0395` to `−0.0009`
...
windows, skill is `−0.2611` at `N=4274`, with a 95% interval from `−0.2910` to
`−0.2330`. Its risk-gate subset is `−0.0204` at `N=780`, with an interval from
`−0.0402` to `0.0007`
...
At watermark block `482560978`, the audit sees 1957 on-chain
anchor events. The ledger accounts for 1956 unique roots; zero
