...
<!-- generated:headline -->
**3260 forecasts · 1420 on-chain anchors · 3238 public proofs · 0 undisclosed
production roots · Brier skill −0.273 across 7 model versions at N=3244.** The
...
`0.3025`; the market's is `0.2376`. Skill is `−0.2731`, with a deterministic
1,000-resample 95% interval from `−0.3027` to `−0.2376` at `N=3244`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0299` at `N=624`, with an interval from
`−0.0518` to `−0.0086`
...
windows, skill is `−0.2692` at `N=3027`, with a 95% interval from `−0.3041` to
`−0.2362`. Its risk-gate subset is `−0.0305` at `N=572`, with an interval from
`−0.0529` to `−0.0045`
...
At watermark block `477882077`, the audit sees 1421 on-chain
roots, 1420 disclosed roots and zero hidden roots
