...
<!-- generated:headline -->
**3008 forecasts · 1317 on-chain anchors · 2992 public proofs · 0 undisclosed
production roots · Brier skill −0.276 across 7 model versions at N=2998.** The
...
`0.3045`; the market's is `0.2387`. Skill is `−0.2756`, with a deterministic
1,000-resample 95% interval from `−0.3102` to `−0.2418` at `N=2998`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0279` at `N=583`, with an interval from
`−0.0492` to `−0.0047`
...
windows, skill is `−0.2716` at `N=2781`, with a 95% interval from `−0.3066` to
`−0.2362`. Its risk-gate subset is `−0.0284` at `N=531`, with an interval from
`−0.0524` to `−0.0059`
...
At watermark block `477557461`, the audit sees 1318 on-chain
roots, 1317 disclosed roots and zero hidden roots
