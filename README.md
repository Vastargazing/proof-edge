...
<!-- generated:headline -->
**4253 forecasts · 1837 disclosed roots · 4239 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4245.** The
...
`0.2996`; the market's is `0.2363`. Skill is `−0.2681`, with a deterministic
1,000-resample 95% interval from `−0.2957` to `−0.2405` at `N=4245`
...
windows, skill is `−0.2649` at `N=4028`, with a 95% interval from `−0.2960` to
`−0.2350`. Its risk-gate subset is `−0.0211` at `N=732`, with an interval from
`−0.0409` to `−0.0012`
...
At watermark block `480941287`, the audit sees 1838 on-chain
anchor events. The ledger accounts for 1837 unique roots; zero
