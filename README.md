...
<!-- generated:hook -->
Our estimator's Brier loss was 25.7% worse than the market's. We know
...
<!-- generated:headline -->
**2146 forecasts · 941 on-chain anchors · 2125 public proofs · 0 undisclosed
production roots · Brier skill −0.257 across 7 model versions at N=2131.** The
...
`0.2992`; the market's is `0.2379`. Skill is `−0.2575`, with a deterministic
1,000-resample 95% interval from `−0.2957` to `−0.2194` at `N=2131`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0332` at `N=426`, with an interval from
`−0.0592` to `−0.0074`
...
windows, skill is `−0.2495` at `N=1914`, with a 95% interval from `−0.2943` to
`−0.2077`. Its risk-gate subset is `−0.0345` at `N=374`, with an interval from
`−0.0609` to `−0.0066`
...
At watermark block `476082411`, the audit sees 942 on-chain
roots, 941 disclosed roots and zero hidden roots
