...
<!-- generated:headline -->
**3673 forecasts · 1594 disclosed roots · 3651 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=3657.** The
...
`0.3001`; the market's is `0.2365`. Skill is `−0.2688`, with a deterministic
1,000-resample 95% interval from `−0.3000` to `−0.2397` at `N=3657`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0203` at `N=697`, with an interval from
`−0.0418` to `0.0014`
...
windows, skill is `−0.2650` at `N=3440`, with a 95% interval from `−0.2971` to
`−0.2332`. Its risk-gate subset is `−0.0201` at `N=645`, with an interval from
`−0.0391` to `0.0026`
...
At watermark block `478313970`, the audit sees 1595 on-chain
anchor events. The ledger accounts for 1594 unique roots; zero
