...
<!-- generated:headline -->
**4247 forecasts · 1832 disclosed roots · 4229 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=4235.** The
...
1,000-resample 95% interval from `−0.2974` to `−0.2391` at `N=4235`
...
windows, skill is `−0.2642` at `N=4018`, with a 95% interval from `−0.2955` to
`−0.2343`. Its risk-gate subset is `−0.0211` at `N=732`, with an interval from
`−0.0409` to `−0.0012`
...
At watermark block `480796774`, the audit sees 1833 on-chain
anchor events. The ledger accounts for 1832 unique roots; zero
