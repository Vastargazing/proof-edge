...
<!-- generated:hook -->
Our estimator's Brier loss was 25.6% worse than the market's. We know
...
<!-- generated:headline -->
**1985 forecasts · 870 on-chain anchors · 1963 public proofs · 0 undisclosed
production roots · Brier skill −0.256 across 7 model versions at N=1969.** The
...
`0.2983`; the market's is `0.2374`. Skill is `−0.2564`, with a deterministic
1,000-resample 95% interval from `−0.2955` to `−0.2158` at `N=1969`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0262` at `N=398`, with an interval from
`−0.0538` to `0.0018`
...
windows, skill is `−0.2475` at `N=1752`, with a 95% interval from `−0.2930` to
`−0.2061`. Its risk-gate subset is `−0.0267` at `N=346`, with an interval from
`−0.0565` to `0.0040`
...
At watermark block `475902349`, the audit sees 871 on-chain
roots, 870 disclosed roots and zero hidden roots
