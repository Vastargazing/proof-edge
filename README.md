...
<!-- generated:headline -->
**3084 forecasts · 1347 on-chain anchors · 3062 public proofs · 0 undisclosed
production roots · Brier skill −0.274 across 7 model versions at N=3068.** The
...
`0.3041`; the market's is `0.2386`. Skill is `−0.2744`, with a deterministic
1,000-resample 95% interval from `−0.3073` to `−0.2395` at `N=3068`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0259` at `N=594`, with an interval from
`−0.0480` to `−0.0032`
...
windows, skill is `−0.2703` at `N=2851`, with a 95% interval from `−0.3046` to
`−0.2352`. Its risk-gate subset is `−0.0261` at `N=542`, with an interval from
`−0.0501` to `−0.0042`
...
At watermark block `477630137`, the audit sees 1348 on-chain
roots, 1347 disclosed roots and zero hidden roots
