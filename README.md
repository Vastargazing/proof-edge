...
<!-- generated:hook -->
Our estimator's Brier loss was 24.3% worse than the market's. We know
...
<!-- generated:headline -->
**1709 forecasts · 746 on-chain anchors · 1687 public proofs · 0 undisclosed
production roots · Brier skill −0.243 across 7 model versions at N=1693.** The
...
`0.2939`; the market's is `0.2365`. Skill is `−0.2427`, with a deterministic
1,000-resample 95% interval from `−0.2918` to `−0.1991` at `N=1693`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0269` at `N=354`, with an interval from
`−0.0540` to `−0.0005`
...
windows, skill is `−0.2301` at `N=1476`, with a 95% interval from `−0.2805` to
`−0.1796`. Its risk-gate subset is `−0.0275` at `N=302`, with an interval from
`−0.0583` to `0.0035`
...
At watermark block `475614614`, the audit sees 747 on-chain
roots, 746 disclosed roots and zero hidden roots
