...
<!-- generated:headline -->
**3949 forecasts · 1713 disclosed roots · 3927 public proofs · 0 undisclosed
production roots · Brier skill −0.273 across 7 model versions at N=3933.** The
...
`0.3010`; the market's is `0.2364`. Skill is `−0.2731`, with a deterministic
1,000-resample 95% interval from `−0.3048` to `−0.2424` at `N=3933`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0213` at `N=725`, with an interval from
`−0.0411` to `0.0000`
...
windows, skill is `−0.2698` at `N=3716`, with a 95% interval from `−0.3002` to
`−0.2391`. Its risk-gate subset is `−0.0211` at `N=673`, with an interval from
`−0.0417` to `−0.0000`
...
At watermark block `478602005`, the audit sees 1714 on-chain
anchor events. The ledger accounts for 1713 unique roots; zero
