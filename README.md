...
<!-- generated:headline -->
**1053 forecasts · 465 on-chain anchors · 1031 public proofs · 0 undisclosed
production roots · Brier skill −0.218 across 7 model versions at N=1037.** The
...
`0.2886`; the market's is `0.2369`. Skill is `−0.2184`, with a deterministic
1,000-resample 95% interval from `−0.2780` to `−0.1628` at `N=1037`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0456` at `N=233`, with an interval from
`−0.0787` to `−0.0113`
...
windows, skill is `−0.1896` at `N=820`, with a 95% interval from `−0.2532` to
`−0.1275`. Its risk-gate subset is `−0.0517` at `N=181`, with an interval from
`−0.0908` to `−0.0150`
...
At watermark block `474930571`, the audit sees 466 on-chain
roots, 465 disclosed roots and zero hidden roots
