...
<!-- generated:headline -->
**4359 forecasts · 1890 disclosed roots · 4345 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4351.** The
...
`0.2984`; the market's is `0.2358`. Skill is `−0.2656`, with a deterministic
1,000-resample 95% interval from `−0.2923` to `−0.2359` at `N=4351`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0220` at `N=802`, with an interval from
`−0.0414` to `−0.0035`
...
windows, skill is `−0.2623` at `N=4134`, with a 95% interval from `−0.2928` to
`−0.2330`. Its risk-gate subset is `−0.0219` at `N=750`, with an interval from
`−0.0414` to `−0.0025`
...
At watermark block `482380964`, the audit sees 1891 on-chain
