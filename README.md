...
<!-- generated:headline -->
**4087 forecasts · 1770 disclosed roots · 4065 public proofs · 0 undisclosed
production roots · Brier skill −0.271 across 7 model versions at N=4071.** The
...
`0.3005`; the market's is `0.2363`. Skill is `−0.2715`, with a deterministic
1,000-resample 95% interval from `−0.3029` to `−0.2442` at `N=4071`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0235` at `N=748`, with an interval from
`−0.0433` to `−0.0040`
...
windows, skill is `−0.2682` at `N=3854`, with a 95% interval from `−0.2977` to
`−0.2375`. Its risk-gate subset is `−0.0235` at `N=696`, with an interval from
`−0.0443` to `−0.0035`
...
At watermark block `478747087`, the audit sees 1771 on-chain
anchor events. The ledger accounts for 1770 unique roots; zero
