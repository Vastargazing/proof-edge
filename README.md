...
<!-- generated:headline -->
**4273 forecasts · 1848 disclosed roots · 4255 public proofs · 0 undisclosed
production roots · Brier skill −0.266 across 7 model versions at N=4261.** The
...
`0.2989`; the market's is `0.2361`. Skill is `−0.2657`, with a deterministic
1,000-resample 95% interval from `−0.2970` to `−0.2360` at `N=4261`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0216` at `N=788`, with an interval from
`−0.0400` to `−0.0013`
...
windows, skill is `−0.2623` at `N=4044`, with a 95% interval from `−0.2923` to
`−0.2322`. Its risk-gate subset is `−0.0215` at `N=736`, with an interval from
`−0.0411` to `−0.0016`
...
At watermark block `481193292`, the audit sees 1849 on-chain
