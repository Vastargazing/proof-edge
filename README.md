...
<!-- generated:headline -->
**4053 forecasts · 1755 disclosed roots · 4031 public proofs · 0 undisclosed
production roots · Brier skill −0.269 across 7 model versions at N=4037.** The
...
`0.2995`; the market's is `0.2360`. Skill is `−0.2691`, with a deterministic
1,000-resample 95% interval from `−0.3010` to `−0.2382` at `N=4037`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0218` at `N=742`, with an interval from
`−0.0410` to `−0.0012`
...
windows, skill is `−0.2658` at `N=3820`, with a 95% interval from `−0.2954` to
`−0.2359`. Its risk-gate subset is `−0.0217` at `N=690`, with an interval from
`−0.0421` to `−0.0020`
...
At watermark block `478709175`, the audit sees 1756 on-chain
anchor events. The ledger accounts for 1755 unique roots; zero
