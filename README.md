...
<!-- generated:headline -->
**2581 forecasts · 1138 on-chain anchors · 2559 public proofs · 0 undisclosed
production roots · Brier skill −0.268 across 7 model versions at N=2565.** The
...
1,000-resample 95% interval from `−0.3051` to `−0.2319` at `N=2565`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0330` at `N=517`, with an interval from
`−0.0553` to `−0.0101`
...
windows, skill is `−0.2626` at `N=2348`, with a 95% interval from `−0.2996` to
`−0.2256`. Its risk-gate subset is `−0.0340` at `N=465`, with an interval from
`−0.0577` to `−0.0077`
...
At watermark block `476550314`, the audit sees 1139 on-chain
roots, 1138 disclosed roots and zero hidden roots
