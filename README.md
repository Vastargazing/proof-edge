...
<!-- generated:headline -->
**3985 forecasts · 1730 disclosed roots · 3963 public proofs · 0 undisclosed
production roots · Brier skill −0.270 across 7 model versions at N=3969.** The
...
`0.3000`; the market's is `0.2362`. Skill is `−0.2703`, with a deterministic
1,000-resample 95% interval from `−0.2988` to `−0.2382` at `N=3969`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. I display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0218` at `N=732`, with an interval from
`−0.0425` to `−0.0022`
...
windows, skill is `−0.2669` at `N=3752`, with a 95% interval from `−0.2975` to
`−0.2361`. Its risk-gate subset is `−0.0217` at `N=680`, with an interval from
`−0.0418` to `0.0001`
...
At watermark block `478637799`, the audit sees 1731 on-chain
anchor events. The ledger accounts for 1730 unique roots; zero
