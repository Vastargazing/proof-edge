...
<!-- generated:headline -->
**420 forecasts · 191 on-chain anchors · 402 public proofs · 0 undisclosed
production roots · Brier skill −0.264 across 7 model versions at N=408.** The
...
`0.3051`; the market's is `0.2413`. Skill is `−0.2645`, with a deterministic
1,000-resample 95% interval from `−0.3671` to `−0.1592` at `N=408`
...
windows, skill is `−0.1956` at `N=191`, with a 95% interval from `−0.3413` to
`−0.0587`. Its risk-gate subset is `−0.0240` at `N=30`, with an interval from
`−0.1251` to `0.0646`
...
At watermark block `474246739`, the audit sees 191 on-chain
roots, 191 disclosed roots and zero hidden roots
