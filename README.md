...
<!-- generated:hook -->
Our estimator's Brier loss was 21.6% worse than the market's. We know
...
<!-- generated:headline -->
**1224 forecasts · 534 on-chain anchors · 1202 public proofs · 0 undisclosed
production roots · Brier skill −0.216 across 7 model versions at N=1208.** The
...
`0.2894`; the market's is `0.2379`. Skill is `−0.2165`, with a deterministic
1,000-resample 95% interval from `−0.2700` to `−0.1655` at `N=1208`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0377` at `N=282`, with an interval from
`−0.0674` to `−0.0059`
...
windows, skill is `−0.1923` at `N=991`, with a 95% interval from `−0.2513` to
`−0.1383`. Its risk-gate subset is `−0.0408` at `N=230`, with an interval from
`−0.0744` to `−0.0072`
...
At watermark block `475110525`, the audit sees 535 on-chain
roots, 534 disclosed roots and zero hidden roots
