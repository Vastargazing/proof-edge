...
<!-- generated:headline -->
**2447 forecasts · 1075 on-chain anchors · 2425 public proofs · 0 undisclosed
production roots · Brier skill −0.263 across 7 model versions at N=2431.** The
...
`0.2997`; the market's is `0.2373`. Skill is `−0.2628`, with a deterministic
1,000-resample 95% interval from `−0.3028` to `−0.2247` at `N=2431`
(`dashboard/app/forecast-data.json`, key `resolve_score.all_evaluated_windows`).
That is a loss. We display it.
<!-- /generated:skill-mixed -->

<!-- generated:skill-gate -->
The mixed-history risk-gate subset is `−0.0325` at `N=491`, with an interval from
`−0.0571` to `−0.0074`
...
windows, skill is `−0.2564` at `N=2214`, with a 95% interval from `−0.2998` to
`−0.2177`. Its risk-gate subset is `−0.0335` at `N=439`, with an interval from
`−0.0599` to `−0.0089`
...
At watermark block `476406343`, the audit sees 1076 on-chain
roots, 1075 disclosed roots and zero hidden roots
